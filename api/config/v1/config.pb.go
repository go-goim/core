...
func (x *ServiceInfo) GetScheme() string {
	if x != nil {
		return x.Scheme
	}
	return ""
...
type Service struct {
	...
	Http *ServiceInfo `protobuf:"bytes,1,opt,name=http,proto3,oneof" json:"http,omitempty"`
	Grpc *ServiceInfo `protobuf:"bytes,2,opt,name=grpc,proto3,oneof" json:"grpc,omitempty"`
}
...
func (x *Service) GetHttp() *ServiceInfo {
	if x != nil {
		return x.Http
	}
	return nil
...
func (x *Service) GetGrpc() *ServiceInfo {
	if x != nil {
		return x.Grpc
	}
	return nil
...
var file_api_config_v1_config_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x22, 0x4d, 0x0a, 0x0b, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x63,
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x85, 0x01, 0x0a, 0x07, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x33, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01,
	...
	0x48, 0x00, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x88, 0x01, 0x01, 0x12, 0x33, 0x0a, 0x04, 0x67,
	0x72, 0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x01, 0x52, 0x04, 0x67, 0x72, 0x70, 0x63, 0x88, 0x01, 0x01,
	0x42, 0x07, 0x0a, 0x05, 0x5f, 0x68, 0x74, 0x74, 0x70, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x67, 0x72,
	0x70, 0x63, 0x42, 0x12, 0x5a, 0x10, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
...
var file_api_config_v1_config_proto_goTypes = []interface{}{
	(*ServiceInfo)(nil), // 0: api.config.v1.ServiceInfo
	(*Service)(nil),     // 1: api.config.v1.Service
}
var file_api_config_v1_config_proto_depIdxs = []int32{
	0, // 0: api.config.v1.Service.http:type_name -> api.config.v1.ServiceInfo
	0, // 1: api.config.v1.Service.grpc:type_name -> api.config.v1.ServiceInfo
