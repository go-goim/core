...
var file_api_user_v1_user_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x70, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x10, 0x0a,
	...
	0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x22, 0x33, 0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x4c,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x22, 0x0a, 0x0e,
	...
	0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0x53, 0x0a, 0x0b, 0x55, 0x73,
...
var file_api_user_v1_user_proto_depIdxs = []int32{
	0, // 0: api.user.v1.UserList.users:type_name -> api.user.v1.User
	0, // 1: api.user.v1.GetUserResponse.user:type_name -> api.user.v1.User
	2, // 2: api.user.v1.UserService.GetUser:input_type -> api.user.v1.GetUserRequest
	3, // 3: api.user.v1.UserService.GetUser:output_type -> api.user.v1.GetUserResponse
