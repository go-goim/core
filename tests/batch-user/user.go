...
//}
//
//func (u *user) addFriend(fuid int64) error {
//	str := fmt.Sprintf(`{"friend_uid":"%d"}`, fuid)
//
...
//
//	if data.Code != 0 {
//		return fmt.Errorf("add friend user=%s, friend=%d, err= %v", u.email, fuid, data.Reason)
//	}
//
//	return nil
//}
//
//func (u *user) queryFriend(email string) (uid int64, err error) {
...
//
//	if data.Code != 0 {
//		return 0, fmt.Errorf("query friend user=%s, friend=%s, err= %v", u.email, email, data.Reason)
//	}
//
//	b, err := json.Marshal(data.Data)
//	if err != nil {
